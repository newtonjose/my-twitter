defmodule MyTwitter.TweetsTest do
  ...
  describe "tweets" do
    ...
    @valid_attrs %{created_at: "some created_at", favorite_count: 42, favorited: true, in_reply_to_screen_name: "some in_reply_to_screen_name", in_reply_to_status_id: 42, in_reply_to_user_id: 42, reply_count: 42, retweet_count: 42, retweeted: true, text: "some text", truncated: true, user: 42}
    @update_attrs %{created_at: "some updated created_at", favorite_count: 43, favorited: false, in_reply_to_screen_name: "some updated in_reply_to_screen_name", in_reply_to_status_id: 43, in_reply_to_user_id: 43, reply_count: 43, retweet_count: 43, retweeted: false, text: "some updated text", truncated: false, user: 43}
    @invalid_attrs %{created_at: nil, favorite_count: nil, favorited: nil, in_reply_to_screen_name: nil, in_reply_to_status_id: nil, in_reply_to_user_id: nil, reply_count: nil, retweet_count: nil, retweeted: nil, text: nil, truncated: nil, user: nil}
    ...
    test "create_tweet/1 with valid data creates a tweet" do
      ...
      assert tweet.truncated == true
      assert tweet.user == 42
    end
    ...
    test "update_tweet/2 with valid data updates the tweet" do
      ...
      assert tweet.truncated == false
      assert tweet.user == 43
    end
